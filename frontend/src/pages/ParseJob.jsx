...
export default function ParseJob() {
  ...
  const handleUpload = () => {
    if (file) {
      ...
      setToast({ message: 'Please select a job post first!', type: 'error' });
    }
  };
  ...
  return (
    <div className="container">
      ...
      <div className="jumbotron">
        ...
        <br />
        <h1 style={{ textAlign: 'center', color: 'black', fontSize: '30px', fontFamily: "'Barlow', sans-serif" }}>Job Description Parser</h1>
        <hr />
        <br />
        <h5 style={{ color: 'black', fontSize: '18px', fontFamily: "'Barlow', sans-serif" }}>
          Upload a <strong>Job Description</strong> and hit the <strong>Parse</strong> button to parse your job description...
        </h5>
        <br />
